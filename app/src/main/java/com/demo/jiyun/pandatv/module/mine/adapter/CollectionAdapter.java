...
public class CollectionAdapter extends RecyclerView.Adapter {
    ...
    private List<Keep> list;
    private LayoutInflater inflater;

    public CollectionAdapter(Context context, List<Keep> list) {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
        ...
        mHolder.item_collection_linear.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                onCollection.onCollection(position);
            }
        });
    }
    ...
    public interface OnCollectionClickLinear {
        void onCollection(int position);
    }

    private OnCollectionClickLinear onCollection;

    public void setOnCollection(OnCollectionClickLinear onCollection) {
