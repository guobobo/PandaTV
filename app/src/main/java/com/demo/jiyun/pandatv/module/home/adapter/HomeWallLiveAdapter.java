...
public class HomeWallLiveAdapter extends  RecyclerView.Adapter{
    ...
    private List<PandaHomeBean.DataBean.WallliveBean.ListBeanX> datas;
    private LayoutInflater inflater;

    public HomeWallLiveAdapter(Context context, List<PandaHomeBean.DataBean.WallliveBean.ListBeanX> datas) {
