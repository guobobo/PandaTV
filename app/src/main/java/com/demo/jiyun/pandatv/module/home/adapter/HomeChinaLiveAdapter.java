...
public class HomeChinaLiveAdapter extends RecyclerView.Adapter {
    private Context context;
    private List<PandaHomeBean.DataBean.ChinaliveBean.ListBeanXX> datas;
    private LayoutInflater inflater;

    public HomeChinaLiveAdapter(Context context, List<PandaHomeBean.DataBean.ChinaliveBean.ListBeanXX> datas) {
